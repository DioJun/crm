...
export class AgendaPage {
  ...
  atualizarEventos() {
    ...
    const events = this.agendamentos.map(ag => {
      ...
      const duracao = ag.duracao || 60
      const start   = new Date(\`\${ag.data}T\${ag.hora}\`)
...
writeFileSync(
  'c:/Users/dioni/OneDrive/Documentos/dev/crm/src/pages/AgendaPage.js',
  out,
  { encoding: 'utf8' }
)
console.log('AgendaPage.js reescrito com UTF-8 correto.')
